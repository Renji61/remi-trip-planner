...
The **public** image is **`ghcr.io/renji61/remi-trip-planner:latest`** (SemVer tags like `:v1.50.4` are published from Git tags).
...
**Pinning:** For production, consider pinning `REMI_IMAGE` to a version tag (e.g. `:v1.50.4`) instead of `:latest`, and bump when you choose.
